...
import com.manik.weathersnap.di.AppModule_ProvideGeocodingApiServiceFactory;
import com.manik.weathersnap.di.AppModule_ProvideReportDaoFactory;
import com.manik.weathersnap.di.AppModule_ProvideWeatherApiServiceFactory;
...
public final class DaggerWeatherSnapApp_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends WeatherSnapApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.imageCompressorProvider = DoubleCheck.provider(new SwitchingProvider<ImageCompressor>(singletonCImpl, 0));
      this.provideWeatherApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<WeatherApiService>(singletonCImpl, 2));
      this.provideGeocodingApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<GeocodingApiService>(singletonCImpl, 3));
      this.provideWeatherDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<WeatherDatabase>(singletonCImpl, 5));
      this.provideReportDaoProvider = DoubleCheck.provider(new SwitchingProvider<ReportDao>(singletonCImpl, 4));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.manik.weathersnap.utils.ImageCompressor 
          return (T) new ImageCompressor();

          case 1: // com.manik.weathersnap.domain.repository.WeatherRepository 
          return (T) AppModule_ProvideWeatherRepositoryFactory.provideWeatherRepository(singletonCImpl.provideWeatherApiServiceProvider.get(), singletonCImpl.provideGeocodingApiServiceProvider.get(), singletonCImpl.provideReportDaoProvider.get());

          case 2: // com.manik.weathersnap.data.remote.WeatherApiService 
          return (T) AppModule_ProvideWeatherApiServiceFactory.provideWeatherApiService();

          case 3: // com.manik.weathersnap.data.remote.GeocodingApiService 
          return (T) AppModule_ProvideGeocodingApiServiceFactory.provideGeocodingApiService();

          case 4: // com.manik.weathersnap.data.local.ReportDao 
          return (T) AppModule_ProvideReportDaoFactory.provideReportDao(singletonCImpl.provideWeatherDatabaseProvider.get());

          case 5: // com.manik.weathersnap.data.local.WeatherDatabase 
